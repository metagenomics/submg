...
## Creating a Study
If a study is already registered with your ENA account, you can use it for this tutorial. Since we are only using the development service here, no data will be submitted to your study.
...
For our mock submission, we can choose `ant fungus garden metagenome`.
```
...
```
### Co-Assembly
The assembly neads a name which just servers as an identifier within your project.
...
ASSEMBLY:                                         
  ...
  ADDITIONAL_MANIFEST_FIELDS: 
BINS:
  BINS_DIRECTORY: "data/3bins"
  COMPLETENESS_SOFTWARE: "CheckM"
  QUALITY_FILE: "data/checkm_quality_3bins.tsv"
